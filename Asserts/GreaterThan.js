...
export default class GreaterThan extends Assert{
    _message = "Il valore è troppo piccolo"
    ...
    constructor( value = undefined, output = null, equal = true, message = undefined ){
        ...
        this.#equal = equal
        this._message = `Il valore deve essere maggiore ${equal ? 'o ugaule a' : 'di'} ${value}`
    }
