...
export default class IsDate extends Assert{
    _message = "Il valore deve essere una data valida"
    
    #strict = true

    static #regex = /^([0-9]{4}\-((0[1-9])|(1[0-2]))\-(([0-2][0-9])|(3[0-1])))$|^(((0[1-9])|(1[0-2]))\-(([0-2][0-9])|(3[0-1]))\-[0-9]{4})$|^((([0-2][0-9])|(3[0-1]))\/((0[1-9])|(1[0-2]))\/[0-9]{4})$/
