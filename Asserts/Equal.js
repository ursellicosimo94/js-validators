...
export default class Equal extends Assert{
    _message = "I valori sono differenti"
     ...
     * @param {Boolean} strict Se true controlla tipo e valore, altrimenti solo il valore
     * @param {string} message Messaggio di errore per input non valido. Se non passato verrà usato "Valore non valido"
     */
    constructor( value = undefined, output = null, strict = true, message = undefined ){
    ...
    resolve(value){
        ...
        this._error = this.#strict ? (value !== this._value) : (value != this._value)
