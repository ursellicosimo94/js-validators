...
export default class Email extends Assert{
    _message = "Il valore deve essere una email valida"
    
    static #regex = /^[a-z]([._-]?[a-z0-9]+)*@[a-z]([._-]?[a-z0-9]+)*\.[a-z][\w\d]+$/i
